...
{
    public sealed class SharpenedBladeDef : CardTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(SharpenedBlade);
        }
        ...
        public override CardConfig MakeConfig()
        {
            var cardConfig = new CardConfig(
              ...
              RelativeEffects: new List<string>() { "SlashPowerUpStatus" },
              UpgradedRelativeEffects: new List<string>() { "SlashPowerUpStatus" },
    ...
    public sealed class SharpenedBlade : Card
    {
        ...
        {
            yield return base.BuffAction<SlashPowerUpStatus>(base.Value1, 0, 0, 0, 0.2f);
            yield break;
        }
    }
}
