...
{
    public sealed class BurnMoreEffect : StatusEffectTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(BurnMoreStatus);
        }
        ...
        {
            return ResourceLoader.LoadSprite("BurnMoreSE.png", BepinexPlugin.embeddedSource);
        }
    ...
    [EntityLogic(typeof(BurnMoreEffect))]
    public sealed class BurnMoreStatus : StatusEffect
    {
        ...
        private IEnumerable<BattleAction> OnEnemyStatusEffectAdded(StatusEffectApplyEventArgs args)
        {
            ...
            if (effect is BurnStatus && args.ActionSource != this)
            {
                base.NotifyActivating();
                yield return new ApplyStatusEffectAction<BurnStatus>(args.Unit, new int?(base.Level), null, null, null, 0, true);
            }
        }
    }
}
